...
window.addEventListener("DOMContentLoaded", function(){
    ...
    // Specific sorting criteria functions
    ...
    document.getElementById("calculare").onclick=function(){
        ...
        if(!document.getElementById("rezultat")){
            ...
            rezultat_calcul.style.border = "2px solid var(--maro)";
            ...
            // As a result of this operation, the rezultat_calcul element will be inserted immediately after the element ps in the DOM tree, as the next sibling of ps. This effectively rearranges the order of elements in the DOM.
    ...
    document.getElementById("resetare").onclick=function(){
        if(confirm("Sunteti siguri ca doriti sa resetati filtrele?") == true){
            ...
            // sa imi selecteze val default toate 
